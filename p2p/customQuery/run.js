...
const PeerDistanceList = require( "../../node_modules/libp2p-kad-dht/src/peer-list/peer-distance-list" );
const EventEmitter = require( "events" );

const Path = require( "../../node_modules/libp2p-kad-dht/src/query/path" );
const WorkerQueue = require( "../../node_modules/libp2p-kad-dht/src/query/worker-queue" );
...
class Run extends EventEmitter {
  ...
  async init() {
    ...
    this.peersQueriedPromise = ( async () => {
      ...
      this.peersQueried = new PeerDistanceList( dhtKey, 20 ); // replace dht.kBucketSize
    } )();
  ...
  async continueQuerying( worker ) {
    ...
    const running = [ ...worker.queuedPeerIds ];
